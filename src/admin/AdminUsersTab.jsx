...
export default function AdminUsersTab() {
  ...
  const clearFine = () => {
    ...
    api.post(`/admin/users/${selectedUser.id}/clear-fine`)
      .then(() =>{
         loadUsers();
            ...
            <div className="col-12 col-md-6 col-lg-4" key={user.id}>
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  ...
                  {user.fine > 0 && (
                    <button className="btn btn-warning btn-sm mt-2" onClick={() => openDialog(user)} >
                      Clear Fine
                    </button>
                  )}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>
                  Are you sure you want to clear fine for:
                  <br />
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-warning" disabled={processingId === selectedUser?.id} onClick={clearFine}>
